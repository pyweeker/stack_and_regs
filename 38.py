...
from silicium_8 import Silicium
...
class MyWindow(arcade.Window):
    ...
    def on_draw(self):
        ...
        for i in range(0,LINES):
            ...
            #arcade.draw_text(str(mySilicium.dico_names2regs["rax"]), 123+ REG_R_x + DECAL_X_REG_names - REG_E_width, ANGLE_Y_REG -i*Y_INTERLINE,arcade.csscolor.CYAN,18,)

            arcade.draw_text(str(mySilicium.dico_names2regs[mySilicium.regsnames[i]]), 123+ REG_R_x + DECAL_X_REG_names - REG_E_width, ANGLE_Y_REG -i*Y_INTERLINE,arcade.csscolor.CYAN,18,)
