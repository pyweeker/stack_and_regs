...
sourcecode_file = "test/9stars.asm"
...
#returned_list_of_lines = trimit(sourcecode_file)
...
class MyWindow(arcade.Window):
    ...
    def on_draw(self):
        ...
        for line_number in range(0, len(self.sourcecode_lines)):
            print("line_number = ", line_number, " type ",type(line_number))
            print(">>>   self.sourcecode_lines[line_number][0]   ", self.sourcecode_lines[line_number][0], " type ",type(self.sourcecode_lines[line_number][0]))
            
            #arcade.draw_text(self.sourcecode_lines[line_number][0], ANGLE_CODE[0] -180, ANGLE_CODE[1] -i* Y_INTERLINE,arcade.csscolor.WHITE,20,)

            #arcade.draw_text(self.sourcecode_lines[line_number][0], 550,550 - line_number * Y_SOURCECODE_DECAL, arcade.csscolor.WHITE,14,)
            ...
            print("ANGLE_CODE[1] = ", ANGLE_CODE[1])
